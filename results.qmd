...
ggplot(df_for_harmful_event) +
  geom_bar(aes(x = Month, fill = First_Harmful_Event), position = "fill")


###Mosaic plot 1:
mosaicplot(table(df_for_harmful_event$First_Harmful_Event, df_for_harmful_event$Hit_Run), main= "Mosaic plot for Hit Run vs First Harmful Event",
...
vcd:: mosaic(Hit_Run ~ First_Harmful_Event,
 data = df_for_harmful_event,
 direction = c("v", "h"), 
 highlighting_fill=c('tomato','darkgreen'), las = 2)
